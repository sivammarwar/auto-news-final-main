      ...
      <main className="flex-1">
        ...
        >
          <div className="mb-10 pb-8 border-b border-border">
            ...
            <h1 className="text-3xl sm:text-5xl font-bold tracking-tightest text-foreground mb-4">Terms of Service</h1>
          ...
          <div className="prose-legal">
            ...
            <Section title="2. Description of Service">
              <p>Signal is a news aggregation and editorial platform that publishes original articles, commentary, and curated news content across various categories including cricket, bollywood, technology, business, health, science, and more.</p>
              <p>Content on Signal is generated and curated independently. Some articles may be produced using automated tools. All content is published in good faith for informational purposes only.</p>
            </Section>
            ...
            <Section title="3. Intellectual Property">
              ...
              <p>Images used on this platform are sourced from Pexels and Wikimedia Commons under their respective free-use licences.</p>
            </Section>
            ...
            <Section title="6. Third-Party Links">
              <p>The Service may contain links to third-party websites or services. These links are provided for convenience only. We have no control over the content, privacy policies, or practices of any third-party sites and accept no responsibility for them.</p>
            </Section>

            <Section title="7. Limitation of Liability">
              <p>To the fullest extent permitted by applicable law, Signal and its operators shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from:</p>
              <ul>
            ...
            <Section title="9. Privacy">
              <p>Your use of the Service is also governed by our <a href="/privacy" className="text-primary hover:underline">Privacy Policy</a>, which is incorporated into these Terms by reference.</p>
            </Section>

            <Section title="10. Governing Law">
              <p>These Terms shall be governed by and construed in accordance with the laws of India, without regard to its conflict of law provisions. Any disputes arising from these Terms shall be subject to the exclusive jurisdiction of the courts of India.</p>
            </Section>

            <Section title="11. Changes to the Service">
              <p>We reserve the right to modify, suspend, or discontinue the Service (or any part of it) at any time, with or without notice. We shall not be liable to you or any third party for any such modification, suspension, or discontinuation.</p>
            </Section>
            ...
            <Section title="13. Entire Agreement">
              <p>These Terms, together with our Privacy Policy, constitute the entire agreement between you and Signal with respect to the Service and supersede all prior agreements, understandings, or representations.</p>
            </Section>
