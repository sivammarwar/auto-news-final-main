...
const CATEGORY_SEO: Record<string, {
  ...
  'history': {
    title:       'History Articles | Signal History',
  ...
  'ancient-civilizations': {
    title:       'Ancient Civilizations | Signal History',
  ...
  'medieval-feudal': {
    title:       'Medieval & Feudal History | Signal History',
  ...
  'age-of-exploration': {
    title:       'Age of Exploration | Signal History',
  ...
  'revolutions-politics': {
    title:       'Revolutions & Politics | Signal History',
  ...
  'world-wars-conflicts': {
    title:       'World Wars & Conflicts | Signal History',
  ...
  'colonial-imperial': {
    title:       'Colonial & Imperial History | Signal History',
  ...
  'human-rights-movements': {
    title:       'Human Rights Movements | Signal History',
  ...
  'science-technology': {
    title:       'History of Science & Technology | Signal History',
  ...
  'religion-philosophy': {
    title:       'Religion & Philosophy History | Signal History',
  ...
  'cultural-social': {
    title:       'Cultural & Social History | Signal History',
  ...
  'economic-trade': {
    title:       'Economic & Trade History | Signal History',
  ...
  'military-warfare': {
    title:       'Military & Warfare History | Signal History',
  ...
  'regional-history': {
    title:       'Regional History | Signal History',
  ...
  'archaeology-mysteries': {
    title:       'Archaeology & Mysteries | Signal History',
  ...
  'famous-figures': {
    title:       'Famous Figures & Leaders | Signal History',
...
export function buildCategoryMetadata(slug: string): Metadata {
  const seo = CATEGORY_SEO[slug] ?? {
    title:       `${slug.replace(/-/g, ' ').replace(/\b\w/g, c => c.toUpperCase())} | Signal History`,
    description: 'Explore history articles on Signal History.',
